        ...
        <div className="grid auto-rows-min gap-4 md:grid-cols-3">
            ...
            <Card className="@container/card">
                <CardHeader>
                    ...
                    <CardTitle className="text-2xl font-semibold tabular-nums @[250px]/card:text-3xl">{statistics.trainingSessions}</CardTitle>
                </CardHeader>
                <CardFooter className="text-sm text-muted-foreground">Training sessions held by you the last 30 days</CardFooter>
            </Card>
        </div>
    );
}
